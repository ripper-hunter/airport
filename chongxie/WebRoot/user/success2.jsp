                            ...
                            <div id="lbox_middlecenter">
                                <div id="lbox_middleleft">
                                    <div id="lbox_middleright">
                                        <div id="bs_left">
                                            <IFRAME scrolling="yes" width="100%" height="80%" frameBorder=0 id=frmleft name=frmleft src="leftPages/accordition4.html" allowTransparency="true">
                                            </IFRAME>
                                        </div>
                            ...
                            <div id="rbox_middlecenter">
                                <div id="rbox_middleleft">
                                    <div id="rbox_middleright">
                                        <div id="bs_right">
                                            <IFRAME scrolling="yes" width="100%" height="100%" frameBorder=0 id=frmright name=frmright src="user/introduce.html" allowTransparency="true">
                                            </IFRAME>
                                        </div>
                                    </div>
                                </div>

...
<h3 align="center">河北重大技术需求征集</h3>
 <div>
  <form id="form3" name="form3" method="post" action="tianbao" target="_parent">
    <table width="1195" height="1570" border="1" align="center">
      <tr>
      	
        <td width="169" height="43">*机构全称</td>
        <td width="299"><label for="quancheng"></label>
        <input type="text"  name="tianbao.quancheng" id="quancheng"  value="<s:property value="#session.quancheng"/>"readonly="false">
        </td>
      ...
      <tr>
        ...
        <input type="text" name="tianbao.tongxun" id="tongxun" value=""/>
      ...
      <tr>
        ...
        <input type="text" name="tianbao.wangzhi" id="wangzhi" value=""/></td>
        <td>*电子邮箱</td>
        <td><label for="youxiang"></label>
        <input type="text" name="tianbao.youxiang" id="youxiang" onBlur="check5()" value=""/>
      ...
      <tr>
        ...
        <input type="text" name="tianbao.daibiao" id="daibiao" value=""/></td>
        <td>邮政编码</td>
        <td><label for="youbian"></label>
        <input type="text" name="tianbao.youbian" id="youbian" value=""/>
      ...
      <tr>
        ...
        <input type="text" name="tianbao.lianxi" id="lianxi" value=""/></td>
        <td>固定电话</td>
        <td><label for="Phone"></label>
        <input type="text" name="tianbao.phone" id="phone" value="" /></td>
      </tr>
      <tr>
        <td height="37">*手机</td>
        <td><label for="mphone"></label>
        <input type="text" name="tianbao.mphone" id="mphone" value="" onblur="check10()" onblur="check13()"/></td>
        <td>传真</td>
        <td><label for="chuanzhen"></label>
        <input type="text" name="tianbao.chuanzhen" id="chuanzhen" value=""/></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <p>
          ...
          <textarea name="tianbao.jianjie" id="jianjie" cols="100" rows="5" placeholder="机构简介" class="comments" width="100%"onKeyDown="textCounter(this.form.jianjie,this.form.Shengyu,500);"   onKeyUp="textCounter(this.form.jianjie,this.form.Shengyu,500);"></textarea>
        </p>
        <p>剩余字数
      ...
      <tr>
        ...
        <input type="text" name="tianbao.jname" id="jname" /></td>
       	<input type="hidden" name="tianbao.jname" id="jname" value="<s:property value="#session.jname"/>"/>
        <td>*需求时限</td>
        <td>
     ...
     <select name='tianbao.zhongzhinian' style="width: 90px;" id="zhongzhinian"onblur="YearYanzheng()">  
      ...
      <tr>
        <td colspan="4"><p>*技术需求概述</p>
          ...
          <textarea name="tianbao.gaishu" id="gaishu" cols="100" rows="5"placeholder="重大需求概述" value="" class="comments"width="100%"onKeyDown="textCounter(this.form.gaishu,this.form.Shengyu1,500);"   onKeyUp="textCounter(this.form.gaishu,this.form.Shengyu1,500);"></textarea>
        <p>剩余字数
